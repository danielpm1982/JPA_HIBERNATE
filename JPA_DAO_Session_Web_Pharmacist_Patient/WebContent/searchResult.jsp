	        ...
	        <div id="table">
	        	...
	        	<c:forEach items="${allPatientsList}" var="item">
		        	<div id="row">
		        		...
		        		<div id="cell5"><a href="controller.do?command=hr&patientId=${item.id}" title="Go To HealthRecord"><img src="healthRecord.png" alt="health record" title="health record" id="healthRecord" /></a></div>
		        	</div>
	        	</c:forEach>
	        </div>
        </c:if>
