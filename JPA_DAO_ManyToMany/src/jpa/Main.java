...
public class Main {
    ...
    private static void insertTest(){
        ...
        dao.insertClient(c1);
        Client c2 = new Client("Client2", Arrays.asList("9999-9999", "7777-5222"), new BigDecimal("2500.5"), LocalDate.of(1990,Month.AUGUST,5), LocalDateTime.of(2002, Month.JULY, 1, 12, 0),Arrays.asList(d2,d3));
        dao.insertClient(c2);
        Client c3 = new Client("Client3", Arrays.asList(""), new BigDecimal("1890.5"), LocalDate.of(1995,Month.DECEMBER,31), LocalDateTime.of(2005, Month.MAY, 5, 12, 0),Arrays.asList(d3));
        dao.insertClient(c3);
        Client c4 = new Client("Client4", Arrays.asList(""), new BigDecimal("1890.5"), LocalDate.of(1995,Month.DECEMBER,31), LocalDateTime.of(2005, Month.MAY, 5, 12, 0),Arrays.asList(d1,d2,d3));
        dao.insertClient(c4);
    ...
    private static void updateClientTest(){
        ...
        Arrays.asList(dao.searchClientByName("Client4")).forEach(x->dao.updateClient(x, new Client("client40", c4.getPhoneNo(), c4.getSalary(), c4.getBirthDate(), c4.getRegisteredIn(), Arrays.asList(d1,d2,d3))));
        System.out.println("Updated!");
    }
