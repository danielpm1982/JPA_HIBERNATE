		...
		if(factory!=null&&factory.isOpen()) {
			...
			try {
				...
				if(customer!=null) {
					...
					request.getRequestDispatcher("/searchResult1.jsp").forward(request, response);
				} else if(customerList!=null&&!customerList.isEmpty()){
					System.out.print("Customer(s) found for the customer name!");
					request.setAttribute("customerList", customerList);
					request.setAttribute("searchName", customerName);
