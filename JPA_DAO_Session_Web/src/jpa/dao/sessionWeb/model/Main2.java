...
//The same as Main but with EntityManager instead of Session. Uses META-INF/persistence.xml config file.

public class Main2 {
	private static EntityManagerFactory factory = Persistence.createEntityManagerFactory("JPA_DAO_Session_WebPU");
